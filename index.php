  ...
  <main id="main">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <p>
              ...
              it was established. Recently, new sector 
              has been introduced into Al Azhar Uni-
              versity implying Engineering since 1964. 
              Al Azhar Engineering International Con-
              ference (AEIC) started since 1989 to be
          ...
          <div class="tab-content">
            <div id="systems_computers" class="tab-pane fade in active show">
              ...
              <ul class="fa-ul">
                ...
                <li><i class="fa-li fa fa-arrow-right"></i>Ai: Health-Education-Covernment</li>
      ...
      <div class="container wow fadeInUp">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-8">
            ...
            <ul class="fa-ul">
              <li><i class="fa-li fa fa-arrow-right"></i>Call for abstract: March 2019</li>
              ...
              <ul id="faq-list">
                ...
                <li>
                  ...
                  <div id="faq3" class="collapse" data-parent="#faq-list">
                    <ul class="fa-ul">
                      ...
                      <li><i class="fa-li fa fa-arrow-right"></i>To identify current applied fields in engineering sciences to update the academic engineering curricula.</li>
                    </ul>
                  </div>
                </li>
                ...
                <li>
                  ...
                  <div id="faq4" class="collapse" data-parent="#faq-list">
                    <ul class="fa-ul">
                      <li><i class="fa-li fa fa-arrow-right"></i>Plenary sessions to present keynote speakers talks.</li>
                      <li><i class="fa-li fa fa-arrow-right"></i>Technical sessions to discuss the accepted papers for aural presentation.</li>
                ...
                <li>
                  ...
                  <div id="faq6" class="collapse" data-parent="#faq-list">
                    <p>
                      All manuscripts must be clearly written in Arabic or in English. The conference provides interpretation service.
                    </p>
                  </div>
                </li>
    ...
    <section id="fees" class="section-with-bg wow fadeInUp sblock">
      <div class="container">
        ...
        <div class="note">
          <p><span>*know That!</span> It is mandatory for at least one author of an accepted paper to register in order for the paper to appear in the proceedings and included in the Presentation. If an author has got more than one accepted papers, there will be a discount on additional papers registration.</p>
        </div>
      </div>
